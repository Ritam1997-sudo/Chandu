   const uploadArea = document.getElementById('upload-area');
    ...
    resizeBtn.addEventListener('click', () => {
      ...
      if (aspect > 1) {
        // Wider than tall
        newWidth = TARGET_PIXELS;
        newHeight = TARGET_PIXELS / aspect;
        xOffset = 0;
        yOffset = (TARGET_PIXELS - newHeight) / 2;
      } else {
        // Taller than wide
        newHeight = TARGET_PIXELS;
        newWidth = TARGET_PIXELS * aspect;
        yOffset = 0;
        xOffset = (TARGET_PIXELS - newWidth) / 2;
      }
    ...
    console.log("2x2 Inch Image Resizer tool (best quality, no cropping) loaded successfully.");
